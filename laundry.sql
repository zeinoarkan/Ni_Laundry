...
(3, 'admin1', '$2y$12$LvDiy6VzCQdutjVLHXxwrO/kqvdeNNW4vDQ8GJXmPVtVJJ/qeUWz2');
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama`, `password`, `no_hp`, `alamat`, `progres_kg`, `bonus`, `bonus_terakhir`) VALUES
(1, 'zeino', '$2y$12$dxLQQUcWB8dq1wRRMm2eu.O/UnFlwkEouoGJFCeN7jLcL3K5oG/hG', '+62895343020667', 'yk', 0.00, 0, NULL),
(2, 'reza', '$2y$12$iCN6z4MLgFZzZQXagReMROwne4H8ska8TYsj49oUXYhGy358vxgga', '+6289347623', 'yk', 0.00, 0, NULL);
...
('fW369JkDP8ZJwvL2XiZsBBKgr92pDZMqHt9EJCKk', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765267910),
('QJTjoUfivRwvZRhcVMwaHLUiozNKTp5iuLx8ypJw', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765290522),
('RxmJbCDWVHYL3fcS1MOmojL8gtkvatFpMDgxHIAj', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765258108),
('WI6JPNYXcFDJpdpiLZtWM3vVQhPeceeO3qNCKWgD', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765285018);
...
--
ALTER TABLE `admin`
  MODIFY `id_admin` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `layanan`
--
ALTER TABLE `layanan`
  MODIFY `id_layanan` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `pesanan`
  MODIFY `id_pesanan` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
