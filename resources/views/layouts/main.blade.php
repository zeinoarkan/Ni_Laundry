...
<head>
    ...
    <link rel="icon" href="{{ asset('img/logo.png') }}" aalt="Logo Ni Laundry" type="image/png">
        ...
        <div class="max-w-7xl mx-auto rounded-2xl transition-all duration-300 border border-transparent"
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="/" class="flex items-center gap-2 md:gap-3 group shrink-0">
                    <img src="{{ asset('img/logo.png') }}" alt="Logo Ni Laundry" class="h-8 md:h-10 w-auto object-contain transition-transform duration-300 group-hover:scale-105">
        ...
        <div x-show="mobileOpen" 
            ...
            <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-4 flex flex-col gap-2">
                ...
                @elseif(Auth::guard('web')->check())
                    ...
                    <a href="/logout" class="p-3 rounded-xl font-medium text-red-500 bg-red-50 mt-2">Logout</a>
                @else
