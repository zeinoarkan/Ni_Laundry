    ...
    <div class="w-full max-w-5xl bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-glass border border-white/50 overflow-hidden grid lg:grid-cols-2 p-2"
        ...
        <div class="p-8 md:p-12 flex flex-col justify-center">
            ...
            <form action="/login" method="POST" class="space-y-5" x-data="{ showPassword: false }">
                ...
                <button type="submit" id="btn-submit" class="w-full py-4 px-6 rounded-2xl bg-brand-600 text-white font-bold text-sm shadow-lg shadow-brand-200 hover:shadow-glow hover:-translate-y-1 hover:bg-brand-700 transition-all duration-300 flex items-center justify-center gap-2 mt-4"
